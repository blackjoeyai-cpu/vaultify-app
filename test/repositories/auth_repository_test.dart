  ...
  group('AuthRepository', () {
    ...
    group('biometric credentials', () {
      test('should save and retrieve biometric credential', () async {
        const encryptedPassword = 'encryptedBiometricPassword123';

        await authRepository.saveBiometricCredential(encryptedPassword);
        final result = await authRepository.getBiometricCredential();

        expect(result, equals(encryptedPassword));
      });
